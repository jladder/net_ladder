...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <c:forEach var="errorLog" items="${errorLogList}">
                <tr>
                    <td>${errorLog.id}</td>
                    <td>${errorLog.name}</td>
                    <td>${errorLog.url}</td>
                    <td>${errorLog.statuscode}</td>
                    <td>${errorLog.contenttype}</td>
                    <td>${errorLog.contentlength}</td>
                    <td>${errorLog.contentencoding}</td>
                    <td>${errorLog.protocolversion}</td>
                    <td>${errorLog.reasonphrase}</td>
                    <td>${errorLog.createtime}</td>
                    <td>${errorLog.content}</td>
                    <td><a href="/net_ladder/errorLog/batchDelete.html?ids=${errorLog.id}">删除</a></td>
                </tr>
            </c:forEach>
        </table>
    </body>
