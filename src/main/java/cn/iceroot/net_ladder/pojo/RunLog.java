...
public class RunLog {
    ...
    public String toString() {
        return "RunLog [id=" + id + ", name=" + name + ", url=" + url + ", statusCode=" + statusCode + ", contentType="
                + contentType + ", contentLength=" + contentLength + ", contentEncoding=" + contentEncoding
                + ", protocolVersion=" + protocolVersion + ", reasonPhrase=" + reasonPhrase + ", createTime="
